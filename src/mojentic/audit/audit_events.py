"""
Defines audit event types for tracking system interactions.
"""
...
class AuditEvent(Event):
    """
    Base class for all audit-specific events.
    
    Audit events are used to track system interactions for observability purposes.
...
class LLMCallAuditEvent(AuditEvent):
    """
...
class LLMResponseAuditEvent(AuditEvent):
    """
...
class AgentInteractionAuditEvent(AuditEvent):
    """
