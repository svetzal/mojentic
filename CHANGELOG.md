...
- Added `ChatSession.send_stream()` method for streaming responses within chat sessions, with full conversation history and context management (closes #17)
- Updated chat sessions documentation with streaming usage examples
- Added cross-reference between streaming docs and chat session streaming
