...
- Updated `openai` (2.29.0→2.31.0) and `anthropic` (0.86.0→0.93.0) to latest compatible versions for security patches
- Updated 3 transitive dependencies to latest compatible versions
...
- Bumped `openai>=2.21.0`, `anthropic>=0.83.0`, `filelock>=3.24.3`, and `urllib3>=2.6.3` to latest compatible versions to patch known CVEs (CVE-2026-22701 in filelock, CVE-2026-21441 in urllib3)
...
- Added minimum version constraints for `filelock>=3.20.1` and `urllib3>=2.6.0` to address known CVEs (CVE-2025-68146, CVE-2026-22701 in filelock; CVE-2025-66418, CVE-2025-66471, CVE-2026-21441 in urllib3)
